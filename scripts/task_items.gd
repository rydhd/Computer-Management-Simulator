...
@onready var task_3: Label = %Task3 
@onready var task_4: Label = %Task4 
...
func _update_task_list() -> void:
	...
	task_3.visible = true
	task_3.text = "3. Insert Cables (Locked)"
	task_3.modulate = Color(0.2, 0.2, 0.2, 0.8) 
	
	task_4.visible = true
	task_4.text = "4. Test PC (Locked)"
	task_4.modulate = Color(0.2, 0.2, 0.2, 0.8) 
	...
	if "Insert Cables" in GlobalState.completed_tasks:
		...
		task_3.text = "3. Insert Cables [DONE]"
		
		# Reveal Task 4
		task_4.text = "4. Test PC"
		task_4.modulate = Color(1.0, 1.0, 1.0, 1.0) 
		
	# If Task 4 is done...
	if "Test PC" in GlobalState.completed_tasks:
		task_4.modulate = Color(0.5, 0.5, 0.5, 0.6) 
		task_4.text = "4. Test PC [DONE]"
